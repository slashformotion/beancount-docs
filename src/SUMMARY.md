...
[Introduction to Beancount 3](README.md)
...
# Reference
- [Beancount 3 Syntax Reference](reference/syntax.md)
- [Options Reference](reference/options.md)
- [Beancount Query Language (BQL)](reference/bql.md)
- [Standard Plugins](reference/standard-plugins.md)
- [Beancount 3 Command Line Interface](reference/cli.md)

# Explanation
- [Double-Entry Principles](explanation/double-entry.md)
- [Continuous Accounting](explanation/continuous-accounting.md)
- [Trade vs. Settlement Dates](explanation/trade-vs-settlement.md)
- [How Inventories Work](explanation/inventories.md)
- [Rounding and Precision](explanation/rounding.md)
- [Why Beancount 3?](explanation/why-beancount-3.md)
